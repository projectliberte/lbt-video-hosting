...
(function ($) {
  ...
  portfolio_lists.forEach((portfolio, i) => {
    gsap.set(portfolio, { opacity: 0.8 })
...
anime.timeline({loop: true})
      ...
      anime.timeline({loop: true})
        ...
        anime.timeline({loop: true})
          ...
          anime.timeline({loop: true})
            ...
            var textWrapper = document.querySelector('.ml24');
            textWrapper.innerHTML = textWrapper.textContent.replace(/\S/g, "<span class='letter'>$&</span>");
            ...
            anime.timeline({loop: true})
              ...
              var textWrapper = document.querySelector('.ml25');
              textWrapper.innerHTML = textWrapper.textContent.replace(/\S/g, "<span class='letter'>$&</span>");
  ...
  $("#features #one").mouseenter(function(){
    $(".main").removeClass("noOpacity");
    $(".one").addClass("noOpacity");
    $(".two").removeClass("noOpacity");
    $(".three").removeClass("noOpacity");
    $(".four").removeClass("noOpacity");
    $(".five").removeClass("noOpacity");
    $(".six").removeClass("noOpacity");
    $(".seven").removeClass("noOpacity");
    $(".eight").removeClass("noOpacity");
    $(".nine").removeClass("noOpacity");
  });

  $("#features #two").mouseenter(function(){
    $(".main").removeClass("noOpacity");
    $(".one").removeClass("noOpacity");
    $(".two").addClass("noOpacity");
    $(".three").removeClass("noOpacity");
    $(".four").removeClass("noOpacity");
    $(".five").removeClass("noOpacity");
    $(".six").removeClass("noOpacity");
  ...
  $("#features #three").mouseenter(function(){
    $(".main").removeClass("noOpacity");
    $(".one").removeClass("noOpacity");
    $(".two").removeClass("noOpacity");
    $(".three").addClass("noOpacity");
    $(".four").removeClass("noOpacity");
    $(".five").removeClass("noOpacity");
    $(".six").removeClass("noOpacity");
    $(".seven").removeClass("noOpacity");
  ...
  $("#features #four").mouseenter(function(){
    $(".main").removeClass("noOpacity");
    $(".one").removeClass("noOpacity");
    $(".two").removeClass("noOpacity");
    $(".three").removeClass("noOpacity");
    $(".four").addClass("noOpacity");
    $(".five").removeClass("noOpacity");
    $(".six").removeClass("noOpacity");
    $(".seven").removeClass("noOpacity");
    $(".eight").removeClass("noOpacity");
  ...
  $("#features #five").mouseenter(function(){
    $(".main").removeClass("noOpacity");
    $(".one").removeClass("noOpacity");
    $(".two").removeClass("noOpacity");
    $(".three").removeClass("noOpacity");
    $(".four").removeClass("noOpacity");
    $(".five").addClass("noOpacity");
    $(".six").removeClass("noOpacity");
    $(".seven").removeClass("noOpacity");
    $(".eight").removeClass("noOpacity");
    $(".nine").removeClass("noOpacity");
  ...
  $("#features #six").mouseenter(function(){
    $(".main").removeClass("noOpacity");
    $(".one").removeClass("noOpacity");
    $(".two").removeClass("noOpacity");
    $(".three").removeClass("noOpacity");
    $(".four").removeClass("noOpacity");
    $(".five").removeClass("noOpacity");
    $(".six").addClass("noOpacity");
    $(".seven").removeClass("noOpacity");
    $(".eight").removeClass("noOpacity");
    $(".nine").removeClass("noOpacity");
  });

  $("#features #seven").mouseenter(function(){
    $(".main").removeClass("noOpacity");
    $(".one").removeClass("noOpacity");
    $(".two").removeClass("noOpacity");
    $(".three").removeClass("noOpacity");
    ...
    $(".five").removeClass("noOpacity");
    $(".six").removeClass("noOpacity");
    $(".seven").addClass("noOpacity");
    $(".eight").removeClass("noOpacity");
    $(".nine").removeClass("noOpacity");
  });

  $("#features #eight").mouseenter(function(){
    $(".main").removeClass("noOpacity");
    $(".one").removeClass("noOpacity");
    $(".two").removeClass("noOpacity");
    $(".three").removeClass("noOpacity");
    ...
    $(".six").removeClass("noOpacity");
    $(".seven").removeClass("noOpacity");
    $(".eight").addClass("noOpacity");
    $(".nine").removeClass("noOpacity");
  });


  $("#features #nine").mouseenter(function(){
    $(".main").removeClass("noOpacity");
    $(".one").removeClass("noOpacity");
    $(".two").removeClass("noOpacity");
    $(".three").removeClass("noOpacity");
    ...
    $(".seven").removeClass("noOpacity");
    $(".eight").removeClass("noOpacity");
    $(".nine").addClass("noOpacity");
  });


  $(".featuresSection .item").click(function(){
    $(".showInDetails").show();
  });

  $("#open_offcanvas").click(function(){
    $(".header__area-3 .header__nav-2 .main-menu-3").show();
  });
